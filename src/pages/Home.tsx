    ...
    >
      ...
      */}
      <section className="relative px-6 lg:px-12 max-w-[1600px] mx-auto mb-32">
        {/* Main Hero Container */}
        <div className="relative h-[85vh] min-h-[700px] rounded-[3rem] overflow-hidden shadow-[0_20px_100px_rgb(0,0,0,0.2)]">
          
          {/* Background Image with Overlay */}
          <div className="absolute inset-0">
            <img
              src="https://images.unsplash.com/photo-1617137968427-85924c800a22?auto=format&fit=crop&q=80&w=1600"
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 lg:px-12">
            ...
            <motion.span 
              ...
              className="mb-8 px-6 py-2 rounded-full bg-white/10 backdrop-blur-md text-white text-xs font-bold tracking-[0.2em] uppercase inline-flex items-center border border-white/20"
            >
              Premium Menswear
            </motion.span>
            ...
            <motion.h1 
              variants={fadeUp}
              className="text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] font-serif font-semibold text-white tracking-widest leading-none mb-6"
            >
              ELVERA
            </motion.h1>
            ...
            <motion.p 
              variants={fadeUp}
              className="text-xl md:text-2xl lg:text-3xl text-white/90 font-medium tracking-wide mb-16 max-w-3xl"
            >
            ...
            >
              <Link
                to="/shop"
                className="group w-full sm:w-auto px-10 py-5 bg-white text-zinc-900 rounded-full text-sm font-bold tracking-widest hover:bg-zinc-100 transition-all flex items-center justify-center gap-3 shadow-[0_10px_40px_rgb(0,0,0,0.3)] hover:shadow-[0_15px_50px_rgb(0,0,0,0.4)] hover:-translate-y-0.5 uppercase"
              >
                Shop Collection
              ...
              <Link
                to="/combos"
                className="group w-full sm:w-auto px-10 py-5 bg-transparent text-white border-2 border-white/30 backdrop-blur-sm rounded-full text-sm font-bold tracking-widest hover:bg-white/10 hover:border-white/50 transition-all flex items-center justify-center gap-3 uppercase"
              >
                View Outfits
              </Link>
            </motion.div>
